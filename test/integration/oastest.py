...
class OasTest(IntegrationTestCase):
    ...
    def testSru(self):
        ...
        self.assertQuery('oa:generatedAt = "2011-02-02"', 1)
        self.assertQuery('oa:annotatedAt = 2010', 3)
        self.assertQuery('oa:annotatedBy = "ex:User"', 1)
        self.assertQuery('oa:generatedBy = "ex:BotUser"', 1)
        ...
        self.assertQuery('api.user = testuser', 11)
        self.assertQuery('api.user = anothertestuser', 10)
        self.assertQuery('set = anothertestuser', 10)
